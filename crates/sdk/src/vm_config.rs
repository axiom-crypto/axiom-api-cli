...
use crate::{
    config::{get_config_id, AxiomConfig, API_KEY_HEADER},
    AxiomSdk,
};

pub trait VmConfigSdk {
...
fn download_artifact(
    ...
    // Load configuration
    let config_id = get_config_id(config_id.map(|s| s.to_string()), config)?;
