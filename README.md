...
1. Install the Axiom CLI:
   ...
   ```
   cargo +1.90 install --locked --git https://github.com/axiom-crypto/axiom-api-cli.git --tag v1.3.0 cargo-axiom
   ```

   Or from source:

   ```bash
   git clone https://github.com/axiom-crypto/axiom-api-cli --tag v1.3.0
