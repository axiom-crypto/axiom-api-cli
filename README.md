...
1. Install the Axiom CLI:
   ...
   ```
   cargo +1.93 install --locked --git https://github.com/axiom-crypto/axiom-api-cli.git --tag v2.0.0 cargo-axiom
   ```

   Or from source:

   ```bash
   git clone https://github.com/axiom-crypto/axiom-api-cli --tag v2.0.0
   cd axiom-api-cli/crates/cli
   cargo +1.93 install --locked --force --path .
   ```
